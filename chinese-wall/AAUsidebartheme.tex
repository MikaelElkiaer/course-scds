...
\begin{frame}
	...
	\node (v5) at (-1,-1) {};
	\draw (v1) -- (v2) -- (v3) -- (v4) -- (v5);
	\node (v7) at (-2,1) {DKB\footnote{Danske Bank}};
	\draw (v6) -- (v3) -- (v7);
	
	\node (v14) at (0,1) {};
	\node (v13) at (2,1) {SOB\footnote{Some Other Bank}};
	\node (v10) at (2,0) {};
	\node (v9) at (1,0) {};
	\node (v8) at (1,-1) {};
	...
	\node (v15) at (0,2) {Banks};
	\draw  (v14) edge (v15);
		
	\node (v30) at (4,2) {};
	\node (v40)at (8,2) {Petrol};
	\node (v23) at (8,1) {};
	\node (v22) at (6,1) {F24};
	\node (v24) at (10,1) {Q8};
	\node (v25) at (10,0) {};
	...
	\node (v31) at (4,3) {All objects};
	\draw  (v30) edge (v31);
	\end{tikzpicture}
	
	\vfill
	
	DKB employees $Johnny, \lnot Johnny$
\end{frame}
